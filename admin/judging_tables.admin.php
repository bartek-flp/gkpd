...
if (($action == "default") && ($filter == "default")) {
    ...
    do {
        ...
        if ($row_tables["tableIsFinal"] == 1) {
            $rejected =  get_table_info("1","count_rejected_in_finals",$row_tables['id'],$dbTable,"default");
            $received -= $rejected;
        }
        ...
        $manage_tables_default_tbody .= "<td>".$row_tables['tableIsFinal']."</td>";
    ...
    */
    ...
    if (strpos($_SESSION['prefsStyleSet'],"BABDB") === false) {
        ...
        do { 
            ...
            /* **MGR */
			//if (($action == "edit") && (in_array($row_styles['id'],$current_table_styles_array)))
                //$style_assigned_location = "<br><em>Style currently assigned to this table.</em>";
			//else 
            /* **MGR */
			...
			if ((($action == "add") /* MGR && (!$show) */) || ($action == "edit")) {
			
				$table_styles_available .= "<tr class=\"".$table_row_class."\">";
				$table_styles_available .= "<td><input type=\"checkbox\" name=\"tableStyles[]\" value=\"".$row_styles['id']."\" "./*$disabled_selected_styles.*/"></td>"; /* **MGR */
...
<div class="bcoem-admin-element hidden-print">
    ...
    <div class="form-group"><!-- Form Group NOT REQUIRED Select -->
        <label for="tableNumber" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label">Finals?</label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
            <div class="input-group">
                <!-- Input Here -->
                <label class="radio-inline">
                    <input type="radio" name="tableIsFinal" value="1" id="tableIsFinal_0" /> Yes
                </label>
                <label class="radio-inline">
                    <input type="radio" name="tableIsFinal" value="0" id="tableIsFinal_1" 
                    <?php if ($action == "add") echo "CHECKED"; ?>/> No
                </label>
            </div>
        </div>
    </div><!-- ./Form Group -->
    ...
    <div class="form-group"><!-- Form Group NOT REQUIRED Select -->
        ...
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
            <div class="input-group">
                <!-- Input Here -->
                <label class="radio-inline">
                    <input type="radio" name="tableIsFinal" value="1" id="tableIsFinal_0" 
                    <?php if ($row_tables_edit['tableIsFinal'] == 1) echo "CHECKED" ?> /> Yes
                </label>
                <label class="radio-inline">
                    <input type="radio" name="tableIsFinal" value="0" id="tableIsFinal_1" 
                    <?php if ($row_tables_edit['tableIsFinal'] == 0) echo "CHECKED" ?>/> No
                </label>
            </div>
        </div>
    </div><!-- ./Form Group -->
