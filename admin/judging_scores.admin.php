...
<tbody>
	...
	if ($row_scores['scorePlace'] == "16") $score_place = "HM"; 
	elseif ($row_scores['scorePlace'] == "17") $score_place =  "Admin Advance"; 
...
<?php
	...
	foreach (array_unique($a) as $value) {
		...
		do {
			...
			if ($totalRows_entries > 0) {
				...
				if (($row_tables_edit['tableIsFinal'] == 1) && (!score_should_be_in_finals($row_entries['id'])))
					continue;

				if ($action == "edit") {
					$score_entry_data = score_entry_data($row_entries['id'], $row_tables_edit['id']);
	...
	<tr>
        ...
        <span class="hidden"><?php if (($action == "edit") && ($score_entry_data[4] == "1")) echo $score_entry_data[4]; ?></span>
            <select class="form-control" name="scorePlace<?php echo $score_id; ?>">
              	<option value=""></option>
                  ...
                  <option value="5" <?php if (($action == "edit") && ($score_entry_data[4] == "5")) echo "SELECTED"; ?>>5th</option>
                  <option value="6" <?php if (($action == "edit") && ($score_entry_data[4] == "6")) echo "SELECTED"; ?>>6th</option>
                  <option value="7" <?php if (($action == "edit") && ($score_entry_data[4] == "7")) echo "SELECTED"; ?>>7th</option>
                  <option value="8" <?php if (($action == "edit") && ($score_entry_data[4] == "8")) echo "SELECTED"; ?>>8th</option>
                  <option value="9" <?php if (($action == "edit") && ($score_entry_data[4] == "9")) echo "SELECTED"; ?>>9th</option>
                  <option value="10" <?php if (($action == "edit") && ($score_entry_data[4] == "10")) echo "SELECTED"; ?>>10th</option>
                  <option value="11" <?php if (($action == "edit") && ($score_entry_data[4] == "11")) echo "SELECTED"; ?>>11th</option>
                  <option value="12" <?php if (($action == "edit") && ($score_entry_data[4] == "12")) echo "SELECTED"; ?>>12th</option>
                  <option value="13" <?php if (($action == "edit") && ($score_entry_data[4] == "13")) echo "SELECTED"; ?>>13th</option>
                  <option value="14" <?php if (($action == "edit") && ($score_entry_data[4] == "14")) echo "SELECTED"; ?>>14th</option>
                  <option value="15" <?php if (($action == "edit") && ($score_entry_data[4] == "15")) echo "SELECTED"; ?>>15th</option>
                  <option value="16" <?php if (($action == "edit") && ($score_entry_data[4] == "16")) echo "SELECTED"; ?>>Hon. Men.</option>
                  <?php } ?>
            </select>
        </td>
	</tr>
