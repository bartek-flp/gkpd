...
if ($section == "entry") {
	...
	$entry_info_text_031 = "Po założeniu konta i zgłoszeniu swoich piw do konkursu opłać wpisowe za każde zgłoszenie. Opłaty należy dokonać na konto nr: 82 1540 1287 2001 6200 5272 0002 Bank Ochrony Środowiska S.A. O/Rzeszów podając w tytule przelewu: <strong>I GKPD + imię i nazwisko piwowara + liczba zgłoszeń do konkursu + informacje o byciu członkiem PSPD (przykładowo: I GKPD Sylwester Murdza 1 nr leg. 666). </strong>(w przypadku browaru domowego i kilku piwowarów należy wskazać nazwisko jednego piwowara na którego zostało założone konto, a jeśli korzysta się ze zniżki dla członków PSPD należy podać nazwisko członka Stowarzyszenia).";
